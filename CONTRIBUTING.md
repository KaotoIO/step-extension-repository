...
Don't forget to explicitly state what is the step extension involved in the bug.

If you are **submitting a step extension**, be ready to follow up and contribute with its development. Step Extensions that are proposed but don't have
...
### Implementing bug fixes or new step extensions
